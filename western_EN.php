    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Movies</b> </span>
        ...
        <ul>
          ...
          <li><a hf="Science_fiction_EN.html">Science_fiction</a></li>
          <li class="active" ><a href="western_EN.php">Western</a></li>
        </ul>
      </div>
      <div class="element">
            <?php
...
$query = "SELECT * FROM movies WHERE  CATEGORIES='Western' AND LANGUAGES='anglais' ORDER BY NOMS";
  try {
