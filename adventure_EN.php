...
<body>
  ...
  <div id="conteneur">
    <div class="element"> <span><b>French Movies</b> </span>
      ...
      <ul>
        <li><a href="acton_EN.html">Action</a></li>
        <li class="active"><a href="adventure_EN.php">Adventure</a></li>
...
// La requete (exemple) : classe par ordre alphabétique.
      $query = "SELECT * FROM movies WHERE  CATEGORIES='Adventure' AND LANGUAGES='anglais' ORDER BY NOMS";
      try {
