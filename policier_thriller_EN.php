    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Movies</b> </span>
        ...
        <ul>
          ...
          <li  class="active" ><a href="policier_thriller_EN.php">Policier/Thriller</a></li>
...
$query = "SELECT * FROM movies WHERE  CATEGORIES='Policier/Thriller' AND LANGUAGES='anglais' ORDER BY NOMS";
  try {
