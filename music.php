...
<!DOCTYPE html><html>
  ...
  <body>
    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Musics</b> </span>
        <ul>
          <li class="active"><a href="music.php">Oldies Cameroon</a></li>
          <li><a href="Africa.php">Africa</a></li>
          <li><a href="Cameroon.php">Cameroon</a></li>
...
$query = "SELECT * FROM musics WHERE CATEGORIES='Oldies Cameroon' ORDER BY NOMS";
  try {
