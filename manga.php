  ...
  <body>
    <div id="tswcsstabs">
      <ul>
        ...
        <li><a href="cartoon.php" class="active">Cartoon</a></li>
    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Movies</b> </span>
        <ul>
          <li><a href="cartoon.php">Animation FR</a></li>
          <li><a href="animation_EN.php">Animation EN</a></li>
          <li class="active"><a href="manga.php">Manga</a></li>
...
$query = "SELECT * FROM cartoon WHERE CATEGORIES='Manga' ORDER BY NOMS";
  try {
