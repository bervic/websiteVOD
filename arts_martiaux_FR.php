  ...
  <div id="conteneur">
    <div class="element"> <span><b>French Movies</b> </span>
      <ul>
        ...
        <li class="active"><a href="arts_martiaux_FR.php">Art Martiaux</a></li>
...
// La requete (exemple) : classe par ordre alphabétique.
      $query = "SELECT * FROM movies WHERE  CATEGORIES='Arts Martiaux' AND LANGUAGES='francais' ORDER BY NOMS";
      try {
