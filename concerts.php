...
<!DOCTYPE html><html>
  ...
  <body>
    ...
    <div id="conteneur">
      <div class="element"> <span><b>Concerts</b> </span>
        <ul>
          <li class="active"><a href="concerts.php">Rap & Rnb</a></li>
...
$query = "SELECT * FROM concerts WHERE  CATEGORIES='Rap & Rnb' ORDER BY NOMS";
  try {
