  ...
  <body>
    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Documentary</b> </span>
        <ul>
          <li><a href="documentary.php">Science</a></li>
        ...
        <ul>
          ...
          <li class="active"><a href="nature_people.php">Nature/People</a></li>
        </ul>
      </div>
      <div class="element">
            <?php
...
$query = "SELECT * FROM documentary WHERE CATEGORIES='Nature/People' AND LANGUAGES='Anglais' ORDER BY NOMS";
  try {
