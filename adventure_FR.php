  ...
  <div id="conteneur">
    <div class="element"> <span><b>French Movies</b> </span>
      <ul>
        ...
        <li class="active"><a href="adventure_FR.php">Adventure</a></li>
      ...
      <ul>
        ...
        <li><a href="arts_martiaux_EN.php">Arts Martiaux</a></li>
...
// La requete (exemple) : classe par ordre alphabétique.
      $query = "SELECT * FROM movies WHERE  CATEGORIES='Adventure' AND LANGUAGES='francais' ORDER BY NOMS";
      try {
