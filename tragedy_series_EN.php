  ...
  <body>
    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Series</b> </span>
        ...
        <ul>
          <li><a href="policier_thriller_series_EN.php">Policier/Thriller</a></li>
          <li class="active"><a href="tragedy_series_EN.php">Tragedy</a></li>
...
$query = "SELECT * FROM series WHERE  CATEGORIES='Tragedy' AND LANGUAGES='Anglais' ORDER BY NOMS";
  try {
