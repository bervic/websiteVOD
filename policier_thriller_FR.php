    ...
    <div id="conteneur">
      <div class="element"> <span><b>French Movies</b> </span>
        <ul>
          ...
          <li class="active"><a href="policier_thriller_FR.php">Policier/Thriller</a></li>
...
$query = "SELECT * FROM movies WHERE  CATEGORIES='Policier/Thriller' AND LANGUAGES='francais' ORDER BY NOMS";
  try {
